  ...
  en: {
    translation: {
      ...
      settings: {
        ...
        noImageMode: "Hide comarca image for more of a challenge.",
        rotationMode: "Randomly rotate comarca image.",
      ...
      championship: {
        ...
        playMapBonus: "Play map bonus",
        playMunicipalitiesBonus: "Play municipalities bonus",
        noBonusWithoutWin: "Shield and map bonuses only score after guessing the comarca.",
        ...
        points: "pts",
        previousMonth: {
          kicker: "{{month}} results",
          title: "Last month's championship",
          subtitle: "The new championship starts today.",
          loading: "Loading last month's results...",
          noData: "No results were recorded last month.",
          winner: "Champion",
          topResults: "Final table",
          yourResult: "Your result",
          yourResultStats: "{{points}} pts in {{days}} days, {{wins}} wins",
          noBonus: "no bonus",
          loginEncouragement: "Register or login to appear in this month's official championship.",
          userEncouragement: "A new month starts from zero. Play today and climb the table.",
          noUserResultEncouragement: "You were not in last month's table. Start today and fight for this month's crown.",
          loginCta: "Register or login",
        },
      },
      municipalitiesBonus: {
        kicker: "Bonus open to everyone",
        title: "Guess the municipalities",
        prompt:
          "{{comarca}} has {{count}} municipalities. Select exactly the {{count}} that belong to it.",
        selected: "Selected: {{selected}}/{{count}}",
        submit: "Answer",
        back: "Back",
        returnToGame: "Return to game",
        correct: "Perfect! You won the municipalities bonus.",
        wrong: "That was not the complete correct selection.",
      },
      username: {
        edit: "Edit Username",
      ...
      install: {
        ...
        description: "Add LoGaliza to Home Screen to play it easily!",
  ...
  fr: {
    translation: {
      ...
      install: {
        ...
        description:
          "Ajouter LoGaliza sur l'écran d'accueil pour le retrouver plus facilement !",
        instructionTitle: "Instructions :",
        instructionActionOk: "OK",
  ...
  hu: {
    translation: {
      ...
      install: {
        ...
        description:
          "Add hozzá a LoGaliza a Kezdőképernyőhöz, hogy egyszerűbben játszhass!",
        instructionTitle: "In",
        instructionActionOk: "OK",
  ...
  nl: {
    translation: {
      ...
      install: {
        ...
        description:
          "Voeg LoGaliza toe aan je beginscherm om het makkelijk te spelen!",
  ...
  pl: {
    translation: {
      ...
      install: {
        ...
        description: "Dodaj LoGaliza do ekranu głównego żeby grać łatwiej!",
  ...
  pt: {
    translation: {
      ...
      settings: {
        ...
        noImageMode: "Esconder imagem da comarca para maior dificuldade.",
        rotationMode: "Rotacionar imagem da comarca randomicamente.",
      ...
      auth: {
        ...
        loginSuccess: "Sessom iniciada!",
        confirmEmail: "Confirma o teu email para completar o registo.",
        needAccount: "Ainda nom tés conta? Regista-te",
        haveAccount: "Já tés conta? Inicia sessom",
        continueWith: "Ou continua com",
      },
      profile: {
        title: "Perfil",
        avatar: "Avatar",
      ...
      championship: {
        ...
        playMapBonus: "Jogar bónus do mapa",
        playMunicipalitiesBonus: "Jogar bónus dos concelhos",
        noBonusWithoutWin: "Os bónus do escudo e do mapa só pontuam depois de acertar a comarca.",
        ...
        points: "pts",
        previousMonth: {
          kicker: "Resultados de {{month}}",
          title: "Campeonato do mês passado",
          subtitle: "Hoje começa um novo campeonato.",
          loading: "Carregando resultados do mês passado...",
          noData: "Nom há resultados registados do mês passado.",
          winner: "Real crown para...",
          topResults: "Classificaçom final",
          yourResult: "O teu resultado",
          yourResultStats: "{{points}} pts em {{days}} dias, {{wins}} vitórias",
          noBonus: "sem bónus",
          loginEncouragement: "Regista-te ou inicia sessom para aparecer no campeonato oficial deste mês.",
          userEncouragement: "Começa um novo mês do zero. Joga hoje e sobe na classificaçom.",
          noUserResultEncouragement: "Nom apareces no campeonato do mês passado. Começa hoje e luita pola coroa deste mês.",
          loginCta: "Registar ou entrar",
        },
      },
      municipalitiesBonus: {
        kicker: "Bónus aberto a toda a gente",
        title: "Adivinha os concelhos",
        prompt:
          "{{comarca}} tem {{count}} concelhos. Escolhe exatamente os {{count}} que a componhem.",
        selected: "Selecionados: {{selected}}/{{count}}",
        submit: "Responder",
        back: "Voltar",
        returnToGame: "Voltar ao jogo",
        correct: "Perfeito! Ganhache o bónus dos concelhos.",
        wrong: "Essa nom era a seleçom correta completa.",
      },
      username: {
        edit: "Editar",
  ...
  de: {
    translation: {
      ...
      install: {
        ...
        description:
          "LoGaliza zum Startbildschirm hinzufügen um einfacher zu spielen!",
  ...
  ja: {
    translation: {
      ...
      install: {
        ...
        description: "ホーム画面にLoGalizaを追加してプレイしやすくしましょう！",
  ...
  co: {
    translation: {
      ...
      install: {
        ...
        description:
          "Aghjunghje LoGaliza à u screnu d’accolta per ghjucà più prestu !",
